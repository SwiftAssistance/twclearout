        ...
        <div className="grid lg:grid-cols-12 gap-12 md:gap-20 items-start text-left">
          <div className="lg:col-span-4 text-left text-slate-900">
            ...
            <div className="flex flex-col gap-3 relative z-[60]">
              <a href="https://share.google/G1JjlRGEG7yKmVMLi" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-slate-900 font-black uppercase italic tracking-wider text-[11px] hover:text-[#16a34a] transition-colors">
                <PlatformLogo platform="google" size={16} /> Read Our Google Reviews
              </a>
              <a href="https://uk.trustpilot.com/review/totalwasteclearout.co.uk" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-slate-900 font-black uppercase italic tracking-wider text-[11px] hover:text-[#00b67a] transition-colors">
                <PlatformLogo platform="trustpilot" size={16} /> Read Our Trustpilot Reviews
              </a>
            </div>
          </div>
          ...
          <Route path="/" element={
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 text-slate-900 text-left">
              <Helmet>
                ...
                <meta name="description" content="Same-day waste removal across Berkshire & Surrey — house, garden & commercial clearance. 94% recycled, licensed, £5M insured. Call 07769 844298." />
