    ...
    <div className={`p-6 md:p-14 border-8 border-slate-900 rounded-[2rem] md:rounded-[3rem] shadow-[10px_10px_0px_#ecf3ef] md:shadow-[20px_20px_0px_#ecf3ef] flex flex-col relative overflow-hidden transition-all ${review.color} h-full min-h-[320px] md:min-h-[460px]`}>
      ...
      <div className="relative z-10 flex-grow text-left mb-6 md:mb-10">
        <div className="flex gap-1 mb-4 md:mb-6">
          {[...Array(5)].map((_, i) => <Star key={i} size={18} fill="currentColor" className={review.accent} />)}
        </div>
        {/* Responsive Text Size for Mobile fix */}
  ...
  <section id="services" className="py-24 md:py-32 bg-white text-left text-slate-900 overflow-hidden">
    <div className="container mx-auto px-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 text-left">
        <div className="lg:col-span-7 bg-[#dcfce7] p-10 md:p-20 flex flex-col justify-end min-h-[400px] border-4 border-slate-900 shadow-[12px_12px_0px_#16a34a] relative overflow-hidden group text-left">
          <Truck size={350} className="absolute top-0 right-0 p-10 opacity-5 text-black group-hover:translate-x-10 transition-transform duration-1000" /><h3 className="text-4xl md:text-6xl font-[1000] text-slate-900 uppercase italic mb-6 leading-none tracking-tight text-left">Full Site <br /> Clear-outs</h3><p className="font-bold text-lg md:text-xl text-slate-700 max-w-sm italic leading-relaxed text-left text-balance">Industrial warehouses and multi-floor office blocks. Professional logistical removal.</p>
        </div>
        <a href="services.html" className="lg:col-span-5 bg-[#064e3b] p-10 md:p-12 border-4 border-slate-900 flex flex-col justify-between shadow-xl text-white group cursor-pointer hover:border-[#4ade80] transition-colors text-left">
        ...
        <article className="lg:col-span-8 bg-[#ecf3ef] border-4 border-slate-900 p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 shadow-lg text-left">
          ...
          <div className="md:w-1/2 overflow-hidden rounded-lg border-2 border-slate-900 h-64 w-full order-1 md:order-2"><img src="https://images.unsplash.com/photo-1591336395884-633009a05531?auto=format&fit=crop&q=80" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700" alt="Exterior Waste Clearance" loading="lazy" /></div>
        </article>
      </div>
    </div>
  </section>
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-orange-500 selection:text-white overflow-x-hidden">
      ...
      <nav role="navigation" className={`fixed top-0 left-0 w-full z-[1000] transition-all duration-300 transform-gpu ${isScrolled ? 'bg-white/95 backdrop-blur-xl border-b border-slate-200 shadow-md py-3' : 'bg-[#064e3b] py-4 md:py-6'}`}>
        <div className="container mx-auto px-6 h-16 flex justify-between items-center relative">
          <button onClick={() => setCurrentView('home')} className="flex items-center gap-3 md:gap-4 shrink-0 group"><div className="relative h-10 w-10 md:h-14 md:w-14 transition-transform group-hover:scale-105"><img src="logo.webp" alt="Logo" className="h-full w-full object-contain relative z-10" loading="eager" /></div><div className="flex flex-col leading-none text-left"><span className={`font-[1000] text-lg md:text-3xl tracking-tighter uppercase italic transition-colors duration-300 ${isScrolled ? 'text-slate-900' : 'text-white'}`}>Total Waste</span><span className="text-[#4ade80] font-black text-[8px] md:text-[10px] tracking-[.3em] md:tracking-[.4em] uppercase text-left text-balance">Clearout Ltd</span></div></button>
            ...
            <section className="bg-[#16a34a] py-6 border-y-4 border-black relative z-20 shadow-xl">
              <div className="container mx-auto px-6 text-left text-white">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-10">
                  {statsList.map((s, idx) => (<div key={`stat-${idx}`} className="flex items-center gap-3 md:gap-5 text-white"><div className="bg-[#064e3b] text-[#4ade80] p-2 md:p-3 rounded-sm shrink-0 shadow-sm"><s.Icon size={20} /></div><div className="flex flex-col text-left"><span className="text-xl md:text-3xl font-black uppercase italic leading-none">{s.value}</span><span className="text-[8px] md:text-[10px] font-bold uppercase tracking-widest opacity-80">{s.label}</span></div></div>))}
                </div>
              </div>
            </section>
            <HomeServices />
        ...
        <div className="container mx-auto px-6 text-left text-white">
          <div className="grid lg:grid-cols-12 gap-12 md:gap-16 mb-20 text-left text-white">
            ...
            <div className="lg:col-span-4 space-y-10 flex flex-col items-start lg:items-end text-left lg:text-right text-white">
               <div className="space-y-3 text-left lg:text-right text-white"><h5 className="font-black text-[#4ade80] uppercase tracking-[0.3em] text-xs italic text-left lg:text-right">Emergency Line</h5><a href="tel:08001234567" className="text-4xl md:text-5xl lg:text-6xl font-[1000] text-white hover:text-orange-500 transition-colors italic tracking-tighter leading-none block text-left lg:text-right">0800 123 4567</a><div className="flex gap-2 lg:justify-end items-center text-left lg:text-right text-white text-balance text-left"><span className="w-2 h-2 bg-[#4ade80] rounded-full animate-pulse" /><span className="text-[10px] font-black uppercase tracking-widest text-white/40 italic text-left">Open 7am — 7pm Daily</span></div></div>
