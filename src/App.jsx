  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-orange-500 selection:text-white overflow-x-hidden">
      ...
      <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end gap-3 pointer-events-none">
        <div className="bg-white text-black px-4 py-2 rounded-lg text-[10px] font-[900] shadow-2xl animate-bounce hidden md:block border-2 border-[#4ade80] pointer-events-auto select-none uppercase tracking-tighter">
        ...
        <div className="container mx-auto px-6 h-16 flex justify-between items-center relative">
          ...
          <a href="#" className="flex items-center gap-3 md:gap-4 shrink-0 group">
            ...
            <div className="flex flex-col leading-none">
              <span className="font-[1000] text-lg md:text-3xl tracking-tighter uppercase italic text-slate-900">Total Waste</span>
              <span className="text-[#16a34a] font-black text-[8px] md:text-[10px] tracking-[.3em] md:tracking-[.4em] uppercase">Clearout Ltd</span>
            </div>
          </a>

          {/* Desktop Navigation Links */}
          <div className="hidden xl:flex items-center gap-8 font-black text-[11px] uppercase tracking-[0.2em] text-slate-600">
            {navLinks.map(link => (
              <a 
                key={link.id} 
                href={link.href} 
      ...
      {/* --- HERO SECTION (LIGHT GREEN VERSION) --- */}
      <header id="home" className="relative min-h-screen flex items-center pt-32 overflow-hidden bg-[#f0fdf4]">
        {/* Subtle Grid Overlay */}
        <div className="absolute inset-0 opacity-[0.4] pointer-events-none">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="light-grid" width="60" height="60" patternUnits="userSpaceOnUse">
                <path d="M 60 0 L 0 0 0 60" fill="none" stroke="#dcfce7" strokeWidth="1"/>
              </pattern>
            </defs>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-8">
              <div className="inline-flex items-center gap-3 bg-white border border-[#4ade80]/40 px-5 py-2.5 rounded-sm text-[10px] md:text-[11px] font-black text-[#16a34a] mb-8 tracking-[.25em] uppercase italic shadow-sm">
                <div className="w-2 h-2 bg-[#16a34a] rounded-full animate-ping shadow-[0_0_10px_#16a34a]" />
                Live: Operations active in Thames Valley Today
              </div>
              <h1 className="text-6xl md:text-[9rem] font-black text-slate-900 leading-[0.85] mb-8 tracking-tighter uppercase italic">
                WASTE <br />
                <span className="text-transparent stroke-text-dark">VANISHED</span> <br />
                <span className="text-[#16a34a]">TODAY.</span>
              </h1>
              <p className="text-xl md:text-3xl text-slate-600 mb-12 max-w-2xl font-bold leading-tight italic">
                Premium waste removal for <span className="text-slate-900 border-b-4 border-orange-500">Berkshire & Surrey</span>. Fully licensed. Fixed pricing. Professional crews.
              </p>

              <div className="flex flex-wrap gap-6 items-center">
                <a 
                  href="#quote" 
                  className="bg-orange-500 hover:bg-orange-400 text-black px-12 py-6 rounded-sm font-black text-xl uppercase italic tracking-wider flex items-center gap-4 transition-all hover:-translate-y-1 shadow-[8px_8px_0px_#16a34a]"
                >
                  Clear My Waste <ArrowRight size={24} />
                </a>
                <div className="flex items-center gap-6 bg-white/50 backdrop-blur p-4 rounded-lg border border-[#dcfce7]">
                  ...
                  <div className="flex flex-col leading-none">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-[#16a34a]">4.9/5 Local Rating</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* --- STATS BAR --- */}
      <section className="bg-[#16a34a] py-8 border-y-4 border-black relative z-20">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-10">
            {stats.map((s, idx) => (
              <div key={idx} className="flex items-center gap-4 md:gap-5">
                <div className="bg-white text-[#16a34a] p-2 md:p-3 rounded-sm shrink-0 shadow-sm">{s.icon}</div>
                <div className="flex flex-col leading-none">
      ...
      {/* --- SERVICES --- */}
      <section id="services" className="py-32 bg-white relative border-b border-slate-100">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-slate-900">
            ...
            <div className="lg:col-span-6 bg-[#dcfce7] p-12 md:p-20 flex flex-col justify-end min-h-[400px] md:min-h-[500px] border-4 border-slate-900 shadow-[15px_15px_0px_#16a34a] relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-10 opacity-5 group-hover:translate-x-10 transition-transform duration-1000">
            ...
            {/* 2. House Clearance */}
            <article className="lg:col-span-3 bg-white group overflow-hidden relative border-4 border-slate-900 h-[400px] md:h-[500px] cursor-pointer shadow-lg">
              ...
              <div className="relative z-20 p-8 h-full flex flex-col justify-between text-white">
                ...
                <div>
                  <h3 className="text-3xl md:text-4xl font-[900] uppercase italic group-hover:text-[#4ade80] transition-colors leading-none">Property Clearances</h3>
            ...
            {/* 3. Office & Retail */}
            <article className="lg:col-span-3 bg-white border-4 border-slate-900 p-8 md:p-10 flex flex-col justify-between hover:border-[#16a34a] transition-all h-[400px] md:h-[500px] shadow-lg group">
            ...
            {/* 4. Builders & Trade */}
            <article className="lg:col-span-5 bg-slate-900 border-4 border-slate-900 p-8 md:p-10 flex flex-col justify-between group hover:bg-orange-500 transition-all duration-700 cursor-pointer min-h-[350px] lg:h-[400px]">
              <div className="flex justify-between items-start text-white">
                <Construction size={54} className="text-[#4ade80] group-hover:text-black mb-4 transition-colors" />
                <div className="text-[10px] font-black uppercase text-slate-400 group-hover:text-black/60 italic tracking-widest">Trade Waste Specialists</div>
              </div>
              <div className="text-white">
                <h3 className="text-4xl md:text-5xl font-[900] group-hover:text-black uppercase italic mb-4 tracking-tighter leading-none">Construction Site</h3>
                <p className="group-hover:text-black/80 font-bold text-base md:text-lg max-w-md italic leading-tight">
            ...
            {/* 5. Garden Evolution */}
            <article className="lg:col-span-7 bg-[#f0fdf4] text-slate-900 p-12 flex flex-col md:flex-row gap-12 items-center border-4 border-slate-900 group h-auto lg:h-[400px] shadow-xl">
              <div className="md:w-1/3 flex justify-center">
                <div className="relative">
                  <div className="absolute inset-0 bg-[#4ade80]/20 blur-2xl group-hover:bg-[#4ade80]/40 transition-all" />
      ...
      {/* --- LOCATIONS --- */}
      <section id="locations" className="py-24 bg-[#f8fafc]">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-12 text-center md:text-left border-t border-slate-200 pt-24">
      ...
      <section id="compliance" className="py-32 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20">
            <div>
              ...
              <div className="space-y-12 text-slate-600">
                <div className="flex gap-8 group">
                   <div className="bg-[#f0fdf4] p-6 rounded-2xl border border-[#dcfce7] group-hover:border-[#16a34a] transition-colors">
            ...
            {/* --- TOUCH ENABLED REVIEW CAROUSEL --- */}
            <div 
              id="reviews" 
              className="bg-[#16a34a] p-10 md:p-20 rounded-[2rem] md:rounded-[3rem] text-white border-8 border-slate-900 shadow-[20px_20px_0px_#f0fdf4] relative overflow-hidden group touch-pan-y"
            ...
            >
              <div className="flex justify-between items-start mb-10">
                ...
                <div className="flex gap-2">
                   <button 
                    onClick={prevReview}
                    className="p-2 border-2 border-white hover:bg-white hover:text-[#16a34a] transition-colors rounded-full hidden md:block"
              ...
              <div className="relative min-h-[180px] md:min-h-[220px]">
                {reviewsData.map((review, idx) => (
                  ...
                  >
                    <p className="text-2xl md:text-3xl font-[1000] uppercase italic leading-[1.1] mb-10 tracking-tight text-white">
                      "{review.text}"
                    </p>
                    <div className="flex items-center gap-6">
                      <div className="w-16 h-16 rounded-full bg-slate-900 flex items-center justify-center font-black text-white italic border-2 border-white text-xl">
                        {review.initials}
                      </div>
                      <div>
                        <p className="font-black uppercase text-base tracking-widest leading-none mb-1 text-white">{review.name}</p>
                        <p className="font-bold opacity-80 text-xs uppercase italic text-white">{review.location} • Verified Review</p>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="flex justify-center gap-2 mt-12 md:hidden">
                {reviewsData.map((_, idx) => (
                  <div 
                    key={idx} 
                    className={`h-2 transition-all duration-300 rounded-full ${idx === currentReview ? 'w-8 bg-white' : 'w-2 bg-white/40'}`}
                  />
                ))}
              </div>
            </div>
      ...
      {/* --- QUOTE HUB --- */}
      <section id="quote" className="py-32 bg-[#f0fdf4] relative overflow-hidden border-t border-slate-200">
        <div className="container mx-auto px-6">
          <div className="bg-white p-8 md:p-20 border-8 border-slate-900 shadow-[15px_15px_0px_#16a34a] md:shadow-[30px_30px_0px_#16a34a] text-slate-900 relative">
            <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3 font-black uppercase italic text-sm text-slate-500">
                    <CheckCircle size={16} className="text-[#16a34a]" /> No Hidden Tipping Fees
                  </div>
                  <div className="flex items-center gap-3 font-black uppercase italic text-sm text-slate-500">
                    <CheckCircle size={16} className="text-[#16a34a]" /> Professional Loaders Included
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-50 p-6 md:p-10 border-4 border-slate-900 rounded-lg">
                 <form className="space-y-8" onSubmit={e => e.preventDefault()}>
                   ...
                   <button className="w-full bg-slate-900 text-white p-6 md:p-8 font-black uppercase tracking-widest italic text-xl md:text-2xl hover:bg-[#16a34a] transition-all shadow-xl active:scale-95">
                     Lock In Fixed Price
                   </button>
                 </form>
              </div>
      ...
      {/* --- FULL ENHANCED FOOTER (LIGHT GREEN BASE) --- */}
      <footer className="bg-[#f0fdf4] pt-24 pb-12 border-t-8 border-[#16a34a]">
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-4 gap-12 md:gap-20 mb-20 text-slate-900">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="flex items-center gap-4 group cursor-pointer">
                ...
                <div className="flex flex-col leading-none">
                  ...
                  <span className="text-[#16a34a] font-black text-sm tracking-[.4em] uppercase">Clearout Ltd</span>
                </div>
              </div>
              <p className="text-slate-600 max-w-sm font-bold italic text-lg leading-relaxed underline decoration-[#dcfce7]">
                Berkshire & Surrey's premier disposal service. 94% recycling rate and 100% legal compliance on every job.
              </p>
              <div className="flex flex-wrap gap-4">
                 <div className="bg-white border-2 border-slate-200 px-6 py-4 text-[10px] font-black uppercase tracking-widest text-slate-600 italic flex items-center gap-2">
                   <ShieldCheck size={14} className="text-[#16a34a]" /> Registered Carrier
                 </div>
                 <div className="bg-white border-2 border-slate-200 px-6 py-4 text-[10px] font-black uppercase tracking-widest text-slate-600 italic flex items-center gap-2">
                   <Scale size={14} className="text-[#16a34a]" /> Insured £5M PLI
                 </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              <h5 className="font-black text-[#16a34a] uppercase tracking-[0.3em] text-xs italic">Clearance Services</h5>
              <ul className="space-y-4 font-black text-xs uppercase tracking-widest italic text-slate-500">
                {['House Clearances', 'Builders Waste', 'Garden Removal', 'Office Rip-outs', 'Sofa Disposal', 'Shed Demolition'].map(service => (
                  <li key={service} className="hover:text-[#16a34a] hover:translate-x-2 transition-all cursor-pointer">
                    {service}
                  </li>
                ))}
              </ul>
            ...
            <div className="space-y-8 flex flex-col items-start lg:items-end text-left lg:text-right">
               <div className="space-y-2">
                 <h5 className="font-black text-[#16a34a] uppercase tracking-[0.3em] text-xs italic">Emergency Line</h5>
                 <a href="tel:08001234567" className="text-4xl md:text-5xl font-[1000] text-slate-900 hover:text-orange-500 transition-colors italic tracking-tighter leading-none block">
                   0800 123 4567
                 </a>
               </div>
               
               <div className="space-y-2">
                 <h5 className="font-black text-[#16a34a] uppercase tracking-[0.3em] text-xs italic">WhatsApp Photos</h5>
                 <a href="https://wa.me/447000000000" target="_blank" rel="noopener noreferrer" className="text-2xl font-black text-slate-600 hover:text-[#25D366] transition-colors italic leading-none block">
                   07000 000 000
                 </a>
               </div>

               <div className="pt-6 flex gap-4 lg:justify-end">
                  <a href="https://www.instagram.com/totalwasteclearout" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-900 rounded-full flex items-center justify-center hover:bg-[#16a34a] transition-colors text-white shadow-lg"><Instagram size={20} /></a>
                  <a href="https://www.facebook.com/totalwasteclearout" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-900 rounded-full flex items-center justify-center hover:bg-[#16a34a] transition-colors text-white shadow-lg"><Facebook size={20} /></a>
                  <a href="#" className="w-10 h-10 bg-slate-900 rounded-full flex items-center justify-center hover:bg-[#16a34a] transition-colors text-white shadow-lg"><Linkedin size={20} /></a>
               </div>
            </div>
          </div>
          ...
          <div className="pt-12 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-8">
            <p className="text-slate-400 text-[9px] font-black uppercase tracking-[0.4em] text-center md:text-left leading-relaxed">
              © 2026 TOTAL WASTE CLEAROUT LTD. COMPANY NO: 09876543. REGISTERED IN ENGLAND. HIGHEST RECYCLING RATES IN THE UK.
            </p>
            <div className="flex gap-6 items-center">
              {['Privacy', 'Legal', 'Duty of Care'].map(item => (
                <a key={item} href="#" className="text-[10px] font-black uppercase text-slate-400 hover:text-[#16a34a] transition-colors italic tracking-widest">{item}</a>
              ))}
              <div className="flex gap-1" aria-hidden="true">
                {[...Array(5)].map((_, i) => <Star key={i} size={12} className="text-[#16a34a] fill-current" />)}
              </div>
            </div>
          </div>
        </div>
