      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
            ...
            <QuoteModal buttonLabel="Get a Quote" buttonClassName="bg-[#4ade80] hover:bg-white text-slate-900 px-8 py-4 rounded-lg font-black text-base uppercase transition-all hover:scale-105 shadow-2xl flex items-center justify-center gap-3" />
          </div>
        </div>
      </div>
    </header>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-6 justify-center mb-12">
            ...
            <QuoteModal buttonLabel="Get a Fixed Quote" buttonClassName="bg-[#4ade80] hover:bg-white text-slate-900 px-8 py-4 rounded-lg font-black text-base uppercase transition-all hover:scale-105 shadow-2xl flex items-center gap-3" />
          </div>
        </div>
      </div>
    </header>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-12 gap-12 md:gap-16 mb-16">
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <a href="mailto:info@totalwasteclearout.co.uk" className="flex items-center gap-3 group">
                  ...
                  <div>
                    <span className="text-white font-black text-sm block leading-tight">info@totalwasteclearout.co.uk</span>
