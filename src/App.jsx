    ...
    <section className="py-24 md:py-32 bg-white">
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          {/* Mission */}
          <div className="mb-20">
            <h2 className="text-4xl md:text-6xl font-black text-slate-900 italic uppercase mb-8 leading-tight">Our Mission</h2>
            <p className="text-xl text-slate-700 font-bold leading-relaxed mb-6">
              At Total Waste Clearout, we're committed to providing <span className="text-[#16a34a]">professional, eco-friendly waste removal</span> services that exceed expectations. Our mission is simple: make waste disappear while protecting our environment.
            </p>
            <p className="text-lg text-slate-600 font-bold leading-relaxed">
              We believe in sustainable practices, which is why we maintain a 94% recycling rate and work with licensed facilities to ensure proper waste management.
            </p>
          </div>

          {/* Why Choose Us */}
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            <div className="bg-[#dcfce7] p-8 border-4 border-slate-900 rounded-2xl">
              <ShieldCheck size={48} className="text-[#16a34a] mb-4" />
              <h3 className="text-2xl font-black uppercase italic mb-4 text-slate-900">Fully Licensed</h3>
            ...
            <div className="bg-[#dcfce7] p-8 border-4 border-slate-900 rounded-2xl">
              ...
              <h3 className="text-2xl font-black uppercase italic mb-4 text-slate-900">Eco-Friendly</h3>
            ...
            <div className="bg-[#dcfce7] p-8 border-4 border-slate-900 rounded-2xl">
              <Users size={48} className="text-[#16a34a] mb-4" />
              <h3 className="text-2xl font-black uppercase italic mb-4 text-slate-900">Professional Team</h3>
            ...
            <div className="bg-[#dcfce7] p-8 border-4 border-slate-900 rounded-2xl">
              <Zap size={48} className="text-[#16a34a] mb-4" />
              <h3 className="text-2xl font-black uppercase italic mb-4 text-slate-900">Fast Response</h3>
          ...
          {/* Service Areas */}
          <div className="bg-slate-900 p-12 rounded-2xl border-4 border-slate-900">
            <h2 className="text-4xl md:text-5xl font-black text-white italic uppercase mb-8 text-center">Coverage Area</h2>
            <p className="text-white/80 text-lg font-bold text-center mb-8">Serving the entire Thames Valley corridor</p>
            <div className="flex flex-wrap justify-center gap-4">
              {TOWNS.map(town => (
                <span key={town} className="bg-white/10 border-2 border-white/20 px-6 py-3 rounded-lg text-white font-black uppercase text-sm flex items-center gap-2">
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-[#dcfce7] p-8 border-4 border-slate-900 rounded-2xl text-center">
              <Phone size={48} className="text-[#16a34a] mx-auto mb-4" />
              <h3 className="text-xl font-black uppercase italic mb-4 text-slate-900">Phone</h3>
            ...
            <div className="bg-[#dcfce7] p-8 border-4 border-slate-900 rounded-2xl text-center">
              ...
              <h3 className="text-xl font-black uppercase italic mb-4 text-slate-900">WhatsApp</h3>
            ...
            <div className="bg-[#dcfce7] p-8 border-4 border-slate-900 rounded-2xl text-center">
              <MapPin size={48} className="text-[#16a34a] mx-auto mb-4" />
              <h3 className="text-xl font-black uppercase italic mb-4 text-slate-900">Service Area</h3>
