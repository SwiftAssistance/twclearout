          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-12 gap-12 md:gap-16 mb-16">
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <a href="https://share.google/LlF3dWmvgamOAhgMy" target="_blank" rel="noopener noreferrer" aria-label="View us on Google Business" className="w-10 h-10 bg-white/5 border border-white/10 rounded-lg flex items-center justify-center hover:bg-white transition-colors group">
