  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <Helmet>
        ...
        <meta name="description" content="Shed demolition, garage & shed clearout in Reading, Slough & Guildford across Berkshire & Surrey. Dismantling, full removal, same-day, licensed. From £100." />
