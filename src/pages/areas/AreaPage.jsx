              ...
              {AREA_SERVICES.map((service, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-slate-600 font-bold text-sm mb-4">{service.description}</p>
                    <div className="flex items-center justify-between">
                      <span className="text-[#16a34a] font-black text-lg">{service.price}</span>
