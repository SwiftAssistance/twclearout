      ...
      <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <header className="relative min-h-[55vh] flex items-center pt-24 md:pt-32 pb-16 md:pb-20 overflow-hidden bg-[#064e3b]">
          <div className="absolute inset-0 z-0">
            <img src="/hero.jpg" alt="Contact Total Waste Clearout for professional waste removal services across Berkshire and Surrey" className="w-full h-full object-cover opacity-15 grayscale" loading="eager" />
