  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white pt-24 pb-16">
      <Helmet>
        ...
        <meta name="description" content="Page not found. Total Waste Clearout provides professional waste removal across Berkshire, Surrey, Hampshire. Call 07769 844298." />
