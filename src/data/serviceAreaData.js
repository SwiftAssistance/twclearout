...
const SERVICE_AREA_DATA = {
  "house-clearance": {
    ...
    getMeta: (area) => ({
      ...
      keywords: `house clearout ${area.name.toLowerCase()}, house clearout ${area.postcode.toLowerCase()}, probate clearout ${area.name.toLowerCase()}, estate clearout ${area.name.toLowerCase()}, home clearout ${area.name.toLowerCase()}, house clearance ${area.name.toLowerCase()}, home clearance ${area.name.toLowerCase()}, probate clearance ${area.name.toLowerCase()}, property clearance ${area.name.toLowerCase()}, furniture removal ${area.name.toLowerCase()}, ${area.postcode} house clearance, ${area.county.toLowerCase()} house clearance, bereavement clearout ${area.name.toLowerCase()}, bereavement clearance ${area.name.toLowerCase()}, full house clearout ${area.name.toLowerCase()}, full house clearance ${area.name.toLowerCase()}, estate clearance ${area.name.toLowerCase()}, deceased estate clearout ${area.name.toLowerCase()}, deceased estate clearance ${area.name.toLowerCase()}, downsizing clearout ${area.name.toLowerCase()}, downsizing clearance ${area.name.toLowerCase()}, landlord house clearout ${area.name.toLowerCase()}, landlord house clearance ${area.name.toLowerCase()}, cheap house clearout ${area.name.toLowerCase()}, cheap house clearance ${area.name.toLowerCase()}, same day house clearout ${area.name.toLowerCase()}, same day house clearance ${area.name.toLowerCase()}, house clearout near me ${area.name.toLowerCase()}, hoarder clearout ${area.name.toLowerCase()}, whole house clearout ${area.name.toLowerCase()}, sofa removal ${area.name.toLowerCase()}, mattress removal ${area.name.toLowerCase()}, white goods removal ${area.name.toLowerCase()}, appliance removal ${area.name.toLowerCase()}`
    })
  },
  ...
  "end-of-tenancy-clearance": {
    ...
    getMeta: (area) => ({
      ...
      keywords: `end of tenancy clearout ${area.name.toLowerCase()}, end of tenancy clearout ${area.postcode.toLowerCase()}, tenant clearout ${area.name.toLowerCase()}, flat clearout ${area.name.toLowerCase()}, rental clearout ${area.name.toLowerCase()}, move out clearout ${area.name.toLowerCase()}, landlord clearout ${area.name.toLowerCase()}, end of tenancy clearance ${area.name.toLowerCase()}, tenant clearance ${area.name.toLowerCase()}, rental clearance ${area.name.toLowerCase()}, move out clearance ${area.name.toLowerCase()}, landlord clearance ${area.name.toLowerCase()}, flat clearance ${area.name.toLowerCase()}, ${area.postcode} end of tenancy, ${area.county.toLowerCase()} tenancy clearance, deposit return clearout ${area.name.toLowerCase()}, deposit return clearance ${area.name.toLowerCase()}, rental property clearout ${area.name.toLowerCase()}, rental property clearance ${area.name.toLowerCase()}, end of lease clearout ${area.name.toLowerCase()}, end of lease clearance ${area.name.toLowerCase()}, letting agent clearance ${area.name.toLowerCase()}, student house clearout ${area.name.toLowerCase()}, student house clearance ${area.name.toLowerCase()}, HMO clearout ${area.name.toLowerCase()}, HMO clearance ${area.name.toLowerCase()}, same day tenancy clearout ${area.name.toLowerCase()}, same day tenancy clearance ${area.name.toLowerCase()}, cheap end of tenancy clearout ${area.name.toLowerCase()}, cheap end of tenancy clearance ${area.name.toLowerCase()}, emergency tenant clearout ${area.name.toLowerCase()}, tenant rubbish removal ${area.name.toLowerCase()}`
    })
  },
  ...
  "garden-waste-removal": {
    ...
    getMeta: (area) => ({
      ...
      keywords: `garden clearout ${area.name.toLowerCase()}, garden clearout ${area.postcode.toLowerCase()}, green waste clearout ${area.name.toLowerCase()}, garden waste removal ${area.name.toLowerCase()}, green waste clearance ${area.name.toLowerCase()}, garden clearance ${area.name.toLowerCase()}, tree removal ${area.name.toLowerCase()}, hedge clearout ${area.name.toLowerCase()}, hedge clearance ${area.name.toLowerCase()}, garden rubbish ${area.name.toLowerCase()}, ${area.postcode} garden waste, ${area.county.toLowerCase()} garden clearout, ${area.county.toLowerCase()} garden clearance, soil removal ${area.name.toLowerCase()}, garden skip alternative ${area.name.toLowerCase()}, tree branch removal ${area.name.toLowerCase()}, hedge trimming waste ${area.name.toLowerCase()}, grass cutting waste ${area.name.toLowerCase()}, turf removal ${area.name.toLowerCase()}, garden furniture disposal ${area.name.toLowerCase()}, fencing removal ${area.name.toLowerCase()}, decking removal ${area.name.toLowerCase()}, landscaping clearout ${area.name.toLowerCase()}, landscaping waste ${area.name.toLowerCase()}, same day garden clearout ${area.name.toLowerCase()}, same day garden waste collection ${area.name.toLowerCase()}, cheap garden clearout ${area.name.toLowerCase()}, cheap garden waste removal ${area.name.toLowerCase()}, compost waste collection ${area.name.toLowerCase()}, green bin alternative ${area.name.toLowerCase()}`
    })
  },
  ...
  "commercial-waste-removal": {
    ...
    getMeta: (area) => ({
      ...
      keywords: `commercial clearout ${area.name.toLowerCase()}, commercial clearout ${area.postcode.toLowerCase()}, office clearout ${area.name.toLowerCase()}, retail clearout ${area.name.toLowerCase()}, restaurant clearout ${area.name.toLowerCase()}, warehouse clearout ${area.name.toLowerCase()}, commercial waste removal ${area.name.toLowerCase()}, office clearance ${area.name.toLowerCase()}, commercial clearance ${area.name.toLowerCase()}, office furniture removal ${area.name.toLowerCase()}, shop strip out ${area.name.toLowerCase()}, business waste ${area.name.toLowerCase()}, ${area.postcode} commercial waste, ${area.county.toLowerCase()} commercial clearout, ${area.county.toLowerCase()} office clearance, IT disposal ${area.name.toLowerCase()}, trade waste ${area.name.toLowerCase()}, office strip out ${area.name.toLowerCase()}, retail clearance ${area.name.toLowerCase()}, restaurant clearance ${area.name.toLowerCase()}, warehouse clearance ${area.name.toLowerCase()}, WEEE disposal ${area.name.toLowerCase()}, IT equipment disposal ${area.name.toLowerCase()}, data destruction ${area.name.toLowerCase()}, out of hours waste collection ${area.name.toLowerCase()}, commercial skip alternative ${area.name.toLowerCase()}, office furniture disposal ${area.name.toLowerCase()}, business clearout ${area.name.toLowerCase()}, business clearance ${area.name.toLowerCase()}, commercial rip out ${area.name.toLowerCase()}`
    })
  },
  ...
  "construction-waste-removal": {
    ...
    getMeta: (area) => ({
      ...
      keywords: `builders clearout ${area.name.toLowerCase()}, builders clearout ${area.postcode.toLowerCase()}, construction clearout ${area.name.toLowerCase()}, building site clearout ${area.name.toLowerCase()}, trade clearout ${area.name.toLowerCase()}, construction waste removal ${area.name.toLowerCase()}, skip alternative ${area.name.toLowerCase()}, building waste ${area.name.toLowerCase()}, rubble removal ${area.name.toLowerCase()}, builder waste ${area.name.toLowerCase()}, trade waste collection ${area.name.toLowerCase()}, ${area.postcode} construction waste, ${area.county.toLowerCase()} builders clearout, ${area.county.toLowerCase()} building waste, renovation clearout ${area.name.toLowerCase()}, renovation waste ${area.name.toLowerCase()}, skip hire alternative ${area.name.toLowerCase()}, rubble clearance ${area.name.toLowerCase()}, plasterboard disposal ${area.name.toLowerCase()}, timber waste removal ${area.name.toLowerCase()}, concrete removal ${area.name.toLowerCase()}, demolition waste ${area.name.toLowerCase()}, kitchen refit waste ${area.name.toLowerCase()}, bathroom refit waste ${area.name.toLowerCase()}, builder skip alternative ${area.name.toLowerCase()}, cheap builders clearout ${area.name.toLowerCase()}, cheap skip alternative ${area.name.toLowerCase()}, same day builders clearout ${area.name.toLowerCase()}, same day builder waste ${area.name.toLowerCase()}, no permit waste removal ${area.name.toLowerCase()}, construction site clearance ${area.name.toLowerCase()}`
    })
  },
  ...
  "garage-shed-clearance": {
    ...
    getDemolition: (area) => ({
      heading: `Shed Demolition in ${area.name}`,
      paragraphs: [
        `Looking specifically for shed demolition in ${area.name}? Total Waste Clearout dismantles and removes garden sheds, workshops, summerhouses, and outbuildings of every type across ${area.name} and all ${area.postcodes[0]} postcodes. Unlike a simple contents clear-out, our shed demolition service takes down the entire structure — timber, metal, or concrete — and clears the base so your garden is left flat and ready for whatever comes next.`,
        `Our ${area.name} shed demolition crews handle rotten timber sheds, rusted metal stores, asbestos-cement sheds (with certified specialist support), concrete sectional sheds, and large workshops. We carefully deconstruct the building, protecting neighbouring fences and gardens, then load every panel, joist, felt, and fixing onto our vehicles. Most single-shed demolitions in ${area.name} are completed in a few hours — often the same day you call.`,
        `Shed demolition in ${area.name} starts from £250 including dismantling, full removal, and site clearance — typically cheaper and faster than hiring a skip, since there are no permits to arrange and no loading for you to do. As a licensed waste carrier we recycle the timber and salvage the metal, providing a waste transfer note for every shed demolition job across ${area.county}.`
      ]
    }),
    getFaqs: (area) => [
      ...
      { q: `How much does shed demolition cost in ${area.name}?`, a: `Shed demolition in ${area.name} starts from £250 for a standard garden shed, including dismantling, complete removal of all materials, and site clearance. Larger sheds, workshops, and concrete sectional sheds are quoted after a quick free assessment. The price always includes loading, transport, and licensed disposal — no skip and no permit needed.` },
    ...
    getMeta: (area) => ({
      title: `Shed Demolition ${area.name} | Garage & Shed Clearance ${area.postcode} | Same-Day`,
      description: `Shed demolition & garage clearance in ${area.name}, ${area.county}. Shed dismantling, contents clearance, full removal. Same-day, site left clean, licensed. From £100. Call 07769 844298.`,
      keywords: `garage clearout ${area.name.toLowerCase()}, garage clearout ${area.postcode.toLowerCase()}, shed clearout ${area.name.toLowerCase()}, outbuilding clearout ${area.name.toLowerCase()}, garage clearance ${area.name.toLowerCase()}, shed clearance ${area.name.toLowerCase()}, garage demolition ${area.name.toLowerCase()}, shed removal ${area.name.toLowerCase()}, outbuilding clearance ${area.name.toLowerCase()}, ${area.postcode} garage clearout, ${area.county.toLowerCase()} garage clearout, ${area.county.toLowerCase()} shed clearout, ${area.county.toLowerCase()} shed demolition, shed demolition ${area.name.toLowerCase()}, garden building removal ${area.name.toLowerCase()}, concrete garage removal ${area.name.toLowerCase()}, prefab garage demolition ${area.name.toLowerCase()}, workshop clearout ${area.name.toLowerCase()}, workshop demolition ${area.name.toLowerCase()}, summerhouse removal ${area.name.toLowerCase()}, shed dismantling ${area.name.toLowerCase()}, garage contents clearout ${area.name.toLowerCase()}, garage contents clearance ${area.name.toLowerCase()}, cheap garage clearout ${area.name.toLowerCase()}, cheap garage clearance ${area.name.toLowerCase()}, same day garage clearout ${area.name.toLowerCase()}, same day shed removal ${area.name.toLowerCase()}, outbuilding demolition ${area.name.toLowerCase()}, garden shed clearout ${area.name.toLowerCase()}, garden shed clearance ${area.name.toLowerCase()}, asbestos garage removal ${area.name.toLowerCase()}`
    })
  }
};
