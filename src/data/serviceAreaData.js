...
const SERVICE_AREA_DATA = {
  "house-clearance": {
    ...
    getMeta: (area) => ({
      ...
      keywords: `house clearance ${area.name.toLowerCase()}, home clearance ${area.name.toLowerCase()}, probate clearance ${area.name.toLowerCase()}, property clearance ${area.name.toLowerCase()}, house clearout ${area.name.toLowerCase()}, furniture removal ${area.name.toLowerCase()}, ${area.postcode} house clearance, ${area.county.toLowerCase()} house clearance, bereavement clearance ${area.name.toLowerCase()}, full house clearance ${area.name.toLowerCase()}, estate clearance ${area.name.toLowerCase()}, deceased estate clearance ${area.name.toLowerCase()}, downsizing clearance ${area.name.toLowerCase()}, landlord house clearance ${area.name.toLowerCase()}, cheap house clearance ${area.name.toLowerCase()}, same day house clearance ${area.name.toLowerCase()}, house clearance near me ${area.name.toLowerCase()}, hoarder clearance ${area.name.toLowerCase()}, whole house clearout ${area.name.toLowerCase()}, sofa removal ${area.name.toLowerCase()}, mattress removal ${area.name.toLowerCase()}, white goods removal ${area.name.toLowerCase()}, appliance removal ${area.name.toLowerCase()}`
    })
  },
